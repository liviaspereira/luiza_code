'''O pessoal da empresa Caça-Clientes trabalha com ligações para números aleatórios.
...
prefixo = input('Digite o prefixo do telefone: ')
primeiro_sufixo = int(input('Digite o primeiro sufixo: '))
ultimo_sufixo = int(input('Digite o ultimo sufixo: '))
for i in range(primeiro_sufixo, ultimo_sufixo + 1):
    print(f'{prefixo}-{i:04}')
